...
func printUsage() {
	...
	fmt.Println("  render          --input=FILE.json --output=IMAGE        Render terrain to image")
	fmt.Println("  render-with-metadata --input=FILE.json --output=IMAGE   Render with embedded metadata")
	fmt.Println("  demo-render     --size=WxH [--seed=N]                    Demo all visualization modes")
	fmt.Println("")
	fmt.Println("Options:")
	...
	fmt.Println("  --mode=TYPE         Render mode: elevation, debug, hillshade")
	fmt.Println("  --scheme=TYPE       Color scheme: elevation, realistic, debug, grayscale")
	fmt.Println("  --width=N           Image width in pixels (default: 800)")
	fmt.Println("  --height=N          Image height in pixels (default: 600)")
	fmt.Println("  --hex-size=N        Hex size in pixels (default: 5.0)")
	fmt.Println("  --quality=N         JPEG quality 1-100 (default: 85)")
	fmt.Println("  --show-coords       Show coordinate debug overlay")
}
